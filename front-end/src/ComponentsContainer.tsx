...
const ComponentsContainer = () => {
	...
	return (
		<div>
			{!apiReady && <Loader text='Waiting to make a connection to the remote endpoint and finishing API initialization.' size="big" />}
			<div id='page-container' style={!apiReady ? { opacity: 0.4 } : {}}>
				<MenuBar />
				<Container>
					<Switch>
						<Route exact path="/">
